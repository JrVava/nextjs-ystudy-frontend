...
export default async function MatureStudents() {
  const data = await getCMSPageContent("mature-students");

  if (!data) {
    return (
      <div style={{ padding: "4rem", textAlign: "center", color: "var(--muted)" }}>
        <h2>Guide Not Found</h2>
        <p>We couldn't retrieve the mature students guide details at this time.</p>
  ...
  return (
    <div className="qualification-page mature-students-page">
      {/* HERO BANNER */}
      <Banner
        slug="mature-students"
        fallbackBadgeText={s1.badge || "Guide · Mature students"}
        fallbackTitle={s1.title || "Mature student guide"}
        fallbackDescription={s1.description || "A simple guide for adults returning to education, changing career or studying while working."}
