...
export default async function FoundationYears() {
  const data = await getCMSPageContent("foundation-years");

  if (!data) {
    return (
      <div style={{ padding: "4rem", textAlign: "center", color: "var(--muted)" }}>
        <h2>Guide Not Found</h2>
        <p>We couldn't retrieve the foundation years guide details at this time.</p>
  ...
  return (
    <div className="qualification-page foundation-years-page">
      {/* HERO BANNER */}
      <Banner
        slug="foundation-years"
        fallbackBadgeText={s1.badge || "Guide · Entry routes"}
        fallbackTitle={s1.title || "Foundation year guide"}
        fallbackDescription={s1.description || "When you do not meet direct entry requirements, a foundation year can be a practical route into a full degree."}
