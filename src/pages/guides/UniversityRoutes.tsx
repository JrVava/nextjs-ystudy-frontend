...
export default async function UniversityRoutes() {
  ...
  if (!data) {
    return (
      <div style={{ padding: "4rem", textAlign: "center", color: "var(--muted)" }}>
        <h2>Routes Page Not Found</h2>
        <p>We couldn't retrieve the university routes guides at this time.</p>
  ...
  return (
    <div className="qualification-page university-routes-page">
      {/* HERO BANNER */}
      <Banner
        slug="university-routes"
        fallbackBadgeText={s1.badge || "University Routes"}
        fallbackTitle={s1.title || "Understand your route into university."}
        fallbackDescription={s1.description || "Compare foundation, HND, top-up, degree and master routes."}
        fallbackBgImage={s1.bgImage || "https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=2000&q=85"}
        fallbackRightCard={{
          layoutType: "grid-2x2",
          title: "Snapshot",
          items: [
        ...
        <section className="conv-section">
          <div className="container">
            <div className="conv-head">
              ...
              <h2>{s2.title || "University Routes"}</h2>
