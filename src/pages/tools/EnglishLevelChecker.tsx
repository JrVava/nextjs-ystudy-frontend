...
import { Banner, QualificationConversionCards, QualificationCrosslinks } from "@/components/ui";
...
export default async function EnglishLevelChecker() {
  const data = await getCMSPageContent("english-test");
  ...
  return (
    <div className="tools-page english-checker-page">
      ...
      <Banner
        ...
        fallbackTitle="Check your English level in 5 minutes."
        fallbackDescription="See if you meet course entry requirements and exactly where to improve — a confidence check before you apply."
        ...
        fallbackRightCard={{
          ...
          title: "Sample result",
          mainValue: "B2 · Strong",
          description: "Meets most course requirements",
          items: [
            { value: "B1", subtitle: "Intermediate" },
            { value: "B2", subtitle: "Upper-intermediate" },
          ],
        }}
      >
      ...
      {/* ENGLISH LEVEL INTERACTIVE WIDGET & AFTER-CARDS */}
      <EnglishLevelWidget sectionData={data?.section_2} section3Data={data?.section_3} />
