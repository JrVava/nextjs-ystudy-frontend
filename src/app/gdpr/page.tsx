...
export default async function GdprPolicy() {
    const data = await getCMSPageContent("gdpr");
    console.log("data?.section_3", data?.section_3);
    if (!data) {
        return (
            <SiteLayout>
            ...
            <main>
                ...
                <section className="legal-main">
                    <div className="container legal-wrap">
...

                        {
                            data?.section_4?.status === true ? (
                                <div className="legal-card">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_4?.description || '' }} />
                                </div>
                            ) : null
                        }
                        ...
                        {
                            data?.section_14?.status === true ? (
                                <div className="legal-card">
                                    <h2>{data?.section_14?.title}</h2>
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_14?.description || '' }} />
                                </div>
                            ) : null
                        }
                    </div>
