...
export default async function CookiesPolicy() {
    const data = await getCMSPageContent("terms-policy");
    console.log("data?.section_2", data?.section_2);
    if (!data) {
        return (
            <SiteLayout>
...

                        {
                            data?.section_3?.status === true ? (
                                <div className="legal-card">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_3?.description || '' }} />
                                </div>
                            ) : null
                        }

                        {
                            data?.section_4?.status === true ? (
                                <div className="legal-card">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_4?.description2 || '' }} />
                                    <ul>
                                        ...
                                        <li><p dangerouslySetInnerHTML={{ __html: data?.section_4?.description5 || '' }} /></li>
                                        <li><p dangerouslySetInnerHTML={{ __html: data?.section_4?.description6 || '' }} /></li>
                                    </ul>
                                </div>
                            ) : null
                        }
...

                        {
                            data?.section_8?.status === true ? (
                                <div className="legal-card">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_8?.description || '' }} />
                                </div>
                            ) : null
                        }
...

                        {
                            data?.section_13?.status === true ? (
                                <div className="legal-card">
                                    ...
                                    <p dangerouslySetInnerHTML={{ __html: data?.section_13?.description || '' }} />
                                </div>
                            ) : null
                        }
                    </div>
