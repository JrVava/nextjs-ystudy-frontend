    ...
    <>
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "center", gap: "clamp(30px,4vw,60px)" }}>
            <div>
              <span className="eyebrow o" style={{ marginBottom: "16px" }}>⚡ 10-second check</span>
              <h2 className="h1" style={{ marginBottom: "14px" }}>Could you get funding?</h2>
              <p className="lead">Answer three quick questions and see your likely Student Finance support — no sign-up, instant result.</p>
            </div>
        ...
        <div className="wrap">
          <div className="povl bleed">
            ...
            <div className="inner wide">
              <span className="eyebrow glass" style={{ marginBottom: "18px" }}>Why YStudy works</span>
              <h2 className="h1" style={{ color: "#fff", marginBottom: "8px" }}>Thousands have found their route.</h2>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow o">Popular degrees</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>Degrees that fit real life.</h2>
            </div>
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "center", gap: "clamp(30px,4vw,60px)" }}>
            <div>
              <span className="eyebrow b" style={{ marginBottom: "16px" }}>🎯 Find your match in 60 seconds</span>
              <h2 className="h1" style={{ marginBottom: "14px" }}>Not sure which degree?</h2>
              <p className="lead" style={{ marginBottom: "22px" }}>Start the Degree Match quiz right here. A few questions about your goals and we'll recommend one clear route.</p>
              <div className="pills">
                <span className="pill">5 min</span><span className="pill o">Free</span><span className="pill">Personalised</span>
              </div>
            </div>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow b">Browse by subject</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>Find your field.</h2>
            </div>
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow o">Free tools</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>Plan your route with free tools.</h2>
            </div>
      ...
      <section className="sec">
        <div className="wrap">
          ...
          <div className="why">
            <div className="r h"><div>What you get</div><div>With YStudy</div><div>Going direct</div></div>
        ...
        <div className="wrap">
          <div className="povl bleed">
            ...
            <div className="inner wide" style={{ maxWidth: "100%", display: "grid", gridTemplateColumns: "1.15fr .85fr", gap: "clamp(28px,3.5vw,56px)", alignItems: "center", width: "100%" }}>
              <div>
                <span className="eyebrow glass" style={{ marginBottom: "16px" }}>Student Finance Hub</span>
                <h2 className="h2" style={{ color: "#fff", marginBottom: "14px" }}>How much could you get?</h2>
                <p className="lead" style={{ color: "#fff", opacity: 0.92, marginBottom: "24px", maxWidth: "460px" }}>Understand tuition loans, maintenance support and grants before you apply — in plain English.</p>
      ...
      <section className="sec ink">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "start", gap: "clamp(28px,3.5vw,56px)" }}>
            <div>
              <span className="eyebrow gold" style={{ marginBottom: "16px" }}>Residency status check</span>
              <h2 className="h1" style={{ color: "#fff", marginBottom: "14px" }}>Student finance eligibility by immigration status.</h2>
              <p className="lead" style={{ color: "#aebed6", marginBottom: "20px" }}>Use this before you choose a course or apply. It helps separate students who are usually stronger for full support from cases that need an adviser check.</p>
              <div className="note-box"><b>Important</b><p>Eligibility still depends on home address, ordinary residence, 3-year residence rules, course designation, previous study, age and Student Finance England assessment.</p></div>
            </div>
            <div className="imm-grid">
              ...
              <article className="imm dark" style={{ gridColumn: "1/-1" }}><div className="top"><span className="code">PS</span><span className="badge part">Adviser check</span></div><h4>EU pre-settled status</h4><p className="desc">Often tuition-fee support only unless another route applies, for example worker or specific family-member rules. Check before promising maintenance.</p></article>
            </div>
          </div>
          <p className="small" style={{ color: "#7e90ad", marginTop: "24px" }}>Guidance based on current GOV.UK student finance residency categories. Final decision is always made by Student Finance England.</p>
        </div>
      </section>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow o">Salary projection</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>What could your route look like?</h2>
            </div>
            <p className="lead">Salary cards create a stronger decision signal for users comparing courses.</p>
          </div>
          ...
          <div className="sal-band">
            <div>
              <h3 className="h2" style={{ marginBottom: "8px", color: "#fff" }}>What could you earn after studying?</h3>
              <p style={{ color: "#cdd9ec", fontWeight: 600 }}>Check salary ranges for business, computing, healthcare, psychology and more.</p>
            </div>
      ...
      <section className="sec ink">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "center", gap: "clamp(28px,3.5vw,56px)" }}>
            <div>
              <span className="eyebrow gold" style={{ marginBottom: "16px" }}>The honest truth about Student Finance</span>
              <h2 className="h1" style={{ color: "#fff", marginBottom: "14px" }}>It's a loan — but a fair one.</h2>
              <p className="lead" style={{ color: "#aebed6", marginBottom: "24px" }}>Student Finance is often misunderstood. We'd rather you know now than be surprised later.</p>
      ...
      <section className="sec tight">
        <div className="wrap">
          <div style={{ background: "linear-gradient(135deg,var(--b-deep),var(--b))", color: "#fff", borderRadius: "20px", padding: "22px 28px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "18px", flexWrap: "wrap" }}>
            <div>
              <b style={{ fontSize: "21px", fontWeight: 900 }}>Next intake: September 2026</b>
              <div style={{ color: "#cdd9ec", fontWeight: 700 }}>Applications close in August — secure your place early.</div>
            </div>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow o">Success stories</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>Real people. Real routes.</h2>
            </div>
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="shead row">
            <div>
              <span className="eyebrow b">Guides &amp; news</span>
              <h2 className="h1" style={{ marginTop: "16px" }}>Read before you decide.</h2>
            </div>
      ...
      <section className="sec ink">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "center", gap: "clamp(28px,3.5vw,56px)" }}>
            <div>
              <span className="eyebrow gold" style={{ marginBottom: "16px" }}>Student journey</span>
              <h2 className="h1" style={{ color: "#fff", marginBottom: "14px" }}>How YStudy supports you.</h2>
              <p className="lead" style={{ color: "#aebed6", marginBottom: "24px" }}>One guided path — not a maze. Eight clear steps from first idea to enrolled, with free support at every stage.</p>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="breaker">
            ...
            <blockquote>You're not behind. You're exactly where your next step begins — and we'll walk it with you.</blockquote>
            <div className="by">— The YStudy promise to every adult learner</div>
          </div>
        </div>
      </section>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="shead">
            <span className="eyebrow b">How it works</span>
            <h2 className="h1" style={{ marginTop: "16px" }}>From unsure to enrolled, in four steps.</h2>
          </div>
          <div className="steps">
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="shead" style={{ textAlign: "center" }}>
            ...
            <h2 className="h1" style={{ marginTop: "16px" }}>Quick answers.</h2>
          </div>
          <div className="faq">
      ...
      <section className="sec soft">
        <div className="wrap">
          <div className="g2" style={{ alignItems: "center", gap: "clamp(28px,3.5vw,56px)" }}>
            <div>
              <span className="eyebrow o" style={{ marginBottom: "16px" }}>Refer a friend</span>
              <h2 className="h1" style={{ marginBottom: "14px" }}>Know someone who'd thrive at university?</h2>
              <p className="lead" style={{ marginBottom: "24px" }}>Pass on their details, with permission. We'll guide them for free, and we'll thank you when they enrol.</p>
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="povl bleed" style={{ minHeight: "clamp(360px,32vw,460px)" }}>
            ...
            <div className="sc sc-blue"></div>
            <div className="inner">
              <span className="eyebrow gold" style={{ marginBottom: "16px" }}>Free adviser support</span>
              <h2 className="h1" style={{ color: "#fff", marginBottom: "14px" }}>Not sure what to choose?</h2>
              <p className="lead" style={{ color: "#fff", opacity: 0.92, marginBottom: "26px", maxWidth: "480px" }}>Book a free call with a real adviser. We'll talk through your goals, funding and the best route — no pressure, no cost.</p>
              <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
      ...
      <section className="sec">
        <div className="wrap">
          <div className="finalcta">
            <h2 className="display" style={{ color: "#fff" }}>Your future starts with one step.</h2>
            <p className="lead">Find your degree, check your funding and apply with free guidance — built around the life you already have.</p>
            <div className="row">
